...
public class Messages {
	...
	public static final String WORLD_DISABLED = ChatColor.RED + "The fill wand has been disabled for this world!";
	public static final String WAND_NAME = ChatColor.GREEN + "Fill Wand (Right click to use)";
	public static final String INVALID_MATERIAL = ChatColor.RED + "Invalid material ID: ";
}
